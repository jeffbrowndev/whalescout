  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("".concat(process.env.DATABASE, "/wp-json/wp/v2/posts?categories=2")).then(function (events) {
            return events.json();
          });
        ...
        case 2:
          ...
          _context.next = 5;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('https://lederconsulting.dreamhosters.com/wp-json/wp/v2/posts?categories=4').then(function (podcasts) {
        ...
        case 5:
          ...
          _context.next = 8;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('https://lederconsulting.dreamhosters.com/wp-json/wp/v2/posts?categories=3').then(function (news) {
            return news.json();
          });
...
//# sourceMappingURL=index.js.e3010eb42c77ae549d33.hot-update.js.map