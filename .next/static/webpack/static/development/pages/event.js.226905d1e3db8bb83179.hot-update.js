...
function (_React$Component) {
  ...
  _createClass(Event, [{
    ...
    value: function componentDidMount() {
      ...
      var event = isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()("http://localhost/whalescout/wp-json/wp/v2/posts?slug=".concat(this.props.url.query.slug)).then(function (event) {
        return event.json();
      }).then(function (event) {
...
//# sourceMappingURL=event.js.226905d1e3db8bb83179.hot-update.js.map