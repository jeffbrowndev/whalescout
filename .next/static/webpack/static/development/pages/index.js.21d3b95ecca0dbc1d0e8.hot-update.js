...
function (_React$Component) {
  ...
  function EventSlider(props) {
    ...
    fetch('https://www.whalescout.org/wp-json/wp/v2/posts').then(function (response) {
      ...
      _this.state = _objectSpread({}, posts);
    });
    return _this;
  }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_event__WEBPACK_IMPORTED_MODULE_2__["default"], {
          date: _this2.isDate(event),
          title: _this2.isTitle(event),
          description: _this2.isDescription(event),
          image: _this2.isImage(event),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 67
          },
...
//# sourceMappingURL=index.js.21d3b95ecca0dbc1d0e8.hot-update.js.map