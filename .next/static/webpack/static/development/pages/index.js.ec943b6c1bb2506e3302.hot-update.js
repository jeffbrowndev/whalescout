    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          _context.next = 8;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('http://localhost/whalescout/wp-json/wp/v2/posts?categories=3').then(function (news) {
            return news.json();
          });

        case 8:
          news = _context.sent;
          // Only grab first 2 podcasts
          podcasts.length = 2;
...
//# sourceMappingURL=index.js.ec943b6c1bb2506e3302.hot-update.js.map