...
const Whitney = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/whitney.jpg`,
  green
);
...
const Juliana = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/juliana.jpg`,
  red
);
...
const Bryan = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/bryan.jpg`,
  blue
);
...
const Kailey = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/kailey.jpg`,
  yellow
);
...
const David = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/david.jpg`,
  green
);
...
const Lindsey = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/03/lindsey.jpg`,
  red
);
...
const Thorly = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/thorly.jpg`,
  blue
);
...
const Ariel = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/ariel.jpg`,
  yellow
);
...
const Caroline = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/caroline.jpg`,
  green
);
...
const Jill = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/jill.jpg`,
  red
);
...
const Laurie = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/laurie.jpg`,
  blue
);
...
const Michelle = new TeamMember(
  ...
  `${database}/wp-content/uploads/2019/05/michelle.jpg`,
  yellow
);
